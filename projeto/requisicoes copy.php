        ...
        <div class="ui-grid-c" style="padding-right: 20px;">
            ...
            <div class="ui-block-b">
                <a href="" data-role="button" data-mini="true"
                    class="ui-link ui-btn ui-btn-a ui-shadow ui-corner-all ui-mini" role="button"
                    data-theme="a">Menu</a>
            </div>
            ...
            <div class="ui-block-c">
                <a href="" data-ajax="false"
                    ...
                    data-mini="true" data-theme="a" role="button">Atualizar</a>
            </div>

            <div class="ui-block-d">
                <button type="submit" form="form1" value="Submit" data-mini="true" data-theme="c"
                    class=" ui-btn ui-btn-c ui-shadow ui-corner-all ui-mini">Submeter</button>
            </div>
        </div>
    </header>
            ...
            echo    "<div style='top: 79% !important; margin-left: 5px !important;' data-role='collapsible' data-theme='c' data-content-theme='b' data-mini='true'>
                            ...
                            <h6 class='ui-collapsible-heading'>
                                <a class='ui-btn'>
                                    ...
                                    <thead> <tr> <th data-priority='1'> </th> <th data-priority='1'> </th> </thead>
                                    <tbody>
                                        <tr> <td> <input type='text' id='id" . $ID_display[$x] . "' name='nmqt" . $prodidInpt[$i] . "' data-theme='a' data-content='a'  placeholder='Quant.'> </td> <td>
                                        <input type='checkbox' name='nmop" . $ID_display[$x] . "' style='margin: 0.4em 0; left: -0.8'> </td> </tr>
                                    </tbody> </table>
                                    <br>
                                </a>
                            </h6>
